...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='Missing data', message='register a face')
...
window.configure(background='#08635d')
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System" ,fg="white",bg="#08635d" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#ff61e5",bg="#08635d" ,width=55 ,height=1,font=('comic', 22, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#ff61e5",bg="#08635d" ,width=55 ,height=1,font=('comic', 22, ' bold '))
